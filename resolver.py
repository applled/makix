...
class BaseResolver:
    ...
    def __init__(self, filename='/data/data/com.termux/files/usr/etc/resolv.conf', configure=True):
        ...
        in standard /data/data/com.termux/files/usr/etc/resolv.conf format.  This parameter is meaningful
        ...
        *configure*, a ``bool``.  If True (the default), the resolver
        ...
        /data/data/com.termux/files/usr/etc/resolv.conf file on POSIX systems and from the registry
        on Windows systems.)
        """
    ...
    def read_resolv_conf(self, f):
        """Process *f* as a file in the /data/data/com.termux/files/usr/etc/resolv.conf format.  If f is
        ...
        with contextlib.ExitStack() as stack:
            if isinstance(f, str):
                try:
                    ...
                    # /data/data/com.termux/files/usr/etc/resolv.conf doesn't exist, can't be read, etc.
...
def reset_default_resolver():
    ...
    Note that the resolver configuration (i.e. /data/data/com.termux/files/usr/etc/resolv.conf on UNIX
...
def override_system_resolver(resolver=None):
    ...
    the system's resolver settings (e.g. /data/data/com.termux/files/usr/etc/resolv.conf).
